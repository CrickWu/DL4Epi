...
bash ./sh/grid_VAR_mask.sh ./data/us_hhs/data.txt ./data/us_hhs/ind_mat.txt hhs 0 1
...
bash ./sh/grid_VAR_mask.sh ./data/us_regions/data.txt ./data/us_regions/ind_mat.txt regions 0 1
